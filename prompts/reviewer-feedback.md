...
Each sub-claim is answered alone: a response to the bare number speaks for none of the letters, and a sub-claim you do not address STANDS rather than riding its siblings' answer. A sub-claim from an EARLIER round keeps its letter even when this report does not repeat it — an unanswered one still stands, and you may answer it now by that letter.
